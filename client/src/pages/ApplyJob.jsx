...
if(userApplications.length > 0 && JobData){
  checkAlreadyApplied()
     ...
     {/* if jobs data is there  then this div will be displayed  */}
  return JobData ?(
   <>
   <Navbar/>
      ...
      <div className='flex flex-col lg:flex-row justify-between items-start mt-4'>
       <div className='w-full lg:w-2/3'>
        ...
        <div className='rich-text' dangerouslySetInnerHTML={{__html:JobData.description}}></div>
         <button onClick={applyHandler} className='bg-blue-600 p-2.5 px-10 text-white rounded capitalize mt-10'>{isAlreadyApplied ? "Already Applied" :"Apply Now"}</button>
       </div>
